#!/bin/bash
#SBATCH --job-name=3dtransformer            # This is the job name that will appear when you search for your jobs on slurm
#SBATCH --output=slurm/3dtransformer.out    # This is the directory of the output file where slurm will show you the output of your run. 

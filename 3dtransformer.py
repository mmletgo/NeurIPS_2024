...
class MultiDimensionalTransformer(nn.Module):
    ...
    def forward(self, x):
        ...
        # 2. 对波长维度升维
        x = x.view(batch_size, num_wavelengths, -1, space_dim
        ...
        x = x.view(-1, num_wavelengths, space_dim
        ...
        x = x.view(-1, space_dim, new_num_wavelengths)
        ...
        x = x.view(batch_size, new_seq_len, new_num_wavelengths, space_dim)
        # 4. 最终 MLP 输出层
        x = x.view(batch_size, -1)  # 展平为 (batch_size, feature_dim)
